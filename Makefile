...
MAN3PODS = README.pod \
	...
	lib/Data/Type/Collection/Chem.pm \
	lib/Data/Type/Collection/DB.pm \
	lib/Data/Type/Collection/Perl.pm \
...
PM_TO_BLIB = lib/Data/Type/Docs/FOP.pod \
	...
	lib/Data/Type/Filter.pm \
	blib/lib/Data/Type/Filter.pm \
	lib/Data/Type/Collection.pm \
	blib/lib/Data/Type/Collection.pm \
	README.pod \
	$(INST_LIB)/Data/README.pod \
	lib/Data/Type/Facet.pm \
	blib/lib/Data/Type/Facet.pm \
	lib/Data/Type/Collection/Chem.pm \
	blib/lib/Data/Type/Collection/Chem.pm \
	lib/Data/Type/Collection/Perl.pm \
	blib/lib/Data/Type/Collection/Perl.pm \
	lib/Data/Type/Query.pm \
	blib/lib/Data/Type/Query.pm \
	lib/Data/Type/Guard.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  ...
	  lib/Data/Type/Facet.pm $(INST_MAN3DIR)/Data::Type::Facet.$(MAN3EXT) \
	  lib/Data/Type/Collection/Chem.pm $(INST_MAN3DIR)/Data::Type::Collection::Chem.$(MAN3EXT) \
	  lib/Data/Type/Collection/Perl.pm $(INST_MAN3DIR)/Data::Type::Collection::Perl.$(MAN3EXT) \
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  ...
	  README.pod $(INST_LIB)/Data/README.pod \
	  lib/Data/Type/Facet.pm blib/lib/Data/Type/Facet.pm \
	  lib/Data/Type/Collection/Chem.pm blib/lib/Data/Type/Collection/Chem.pm \
	  lib/Data/Type/Collection/Perl.pm blib/lib/Data/Type/Collection/Perl.pm \
